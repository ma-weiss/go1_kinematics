 ...
 * 2024-01-18 11:35:57
 */
#include "pos_quaternion_fk_origin_RR_foot.h"
#include <math.h>
#include <stdio.h>
#include <stdlib.h>
...
/*
 * Sub functions pos_quaternion_fk_origin_RR_foot:(i0[18])->(o0[7])
 */
...
void pos_quaternion_fk_origin_RR_foot (Eigen::Matrix<double,7, 1> &p_output0, const Eigen::Matrix<double,18, 1> &var0) {
   /* Call Subroutines */
