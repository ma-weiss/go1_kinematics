 ...
 * 2023-08-17 12:25:55
 */
#include "pos_fk_origin_RL_foot.h"
#include <math.h>
#include <stdio.h>
#include <stdlib.h>
...
/*
 * Sub functions pos_fk_origin_RL_foot:(i0[18])->(o0[3])
 */
...
void pos_fk_origin_RL_foot (Eigen::Matrix<double,3, 1> &p_output0, const Eigen::Matrix<double,18, 1> &var0) {
   /* Call Subroutines */
